...
try:
    ...
    selective_scan_fn, mamba_inner_fn, mamba_inner_fn_no_out_proj = None, None, None, None, None
...
class Mamba(nn.Module):
    def __init__(
            ...
            conv_bias=True,
            bias=False,
            use_fast_path=False,  # Fused kernel options, default is True
            layer_idx=None,
            device=None,
            dtype=None,
        ...
        # skip hf initialization
        self.dt_proj._is_hf_initialized = True
        ...
        # skip hf initialization
        self.dt_proj_b._is_hf_initialized = True
...
if __name__ == '__main__':
    ...
    print('Total trainable parameters are: {}'.format(parameters))
